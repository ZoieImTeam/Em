...
import com.kyluzoi.easeui.widget.EaseExpandGridView;
import com.kyluzoi.easeui.widget.EaseSwitchButton;
import com.kyluzoi.easeui.zoihttp.DialogSelect;
...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogSelectPay = DialogSelect.newInstance("开启会话", "加入群组黑名单", "取消");
                        ...
                        if (group.getOwner().equals(EMClient.getInstance().getCurrentUser())) {
                            dialogSelectPay.setOnSelectLayout(new DialogSelect.OnSelectLayout() {
                                ...
                                public void onClickFirst(String str1, String tag) {
                                    ChatActivity.start(getContext(), username);
                            ...
                            dialogSelectPay.show(getSupportFragmentManager(), "xx");
