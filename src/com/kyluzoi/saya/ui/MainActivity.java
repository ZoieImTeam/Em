...
import com.kyluzoi.saya.web.WebviewFragment;
...
//	private ChatAllHistoryFragment conversationListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebviewFragment webviewFragment=WebviewFragment.newInstance("http://www.jin10.com/");
        fragments = new Fragment[]{conversationListFragment, contactListFragment, settingFragment,webviewFragment};
        // 添加显示第一个fragment
    ...
    private void initView() {
        ...
        // TODO: 2016/8/4 添加点击事件 tab
        mTabs[3] = (Button) findViewById(R.id.btnOther);
        // 把第一个tab设为选中状态
