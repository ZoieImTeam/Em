...
public class EaseTitleBar extends RelativeLayout{
    ...
    protected ImageView GonggaoImage;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        GonggaoImage= (ImageView) findViewById(R.id.ivGonggao);
    ...
    //设置公告资源文件
    public void setRightImageGonggaoResource(int resId)
    {
        GonggaoImage.setImageResource(resId);
    }
    ...
    public void setGonggaoClickListener(OnClickListener listener)
    {
        GonggaoImage.setOnClickListener(listener);
    }
