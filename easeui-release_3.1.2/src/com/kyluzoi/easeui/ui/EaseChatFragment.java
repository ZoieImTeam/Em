...
import com.kyluzoi.easeui.EaseConstant;
import com.kyluzoi.easeui.R;
import com.kyluzoi.easeui.controller.EaseUI;
import com.kyluzoi.easeui.domain.EaseEmojicon;
import com.kyluzoi.easeui.utils.EaseCommonUtils;
import com.kyluzoi.easeui.utils.EaseUserUtils;
import com.kyluzoi.easeui.widget.EaseAlertDialog;
import com.kyluzoi.easeui.widget.EaseAlertDialog.AlertDialogUser;
import com.kyluzoi.easeui.widget.EaseChatExtendMenu;
import com.kyluzoi.easeui.widget.EaseChatInputMenu;
import com.kyluzoi.easeui.widget.EaseChatInputMenu.ChatInputMenuListener;
import com.kyluzoi.easeui.widget.EaseChatMessageList;
import com.kyluzoi.easeui.widget.EaseVoiceRecorderView;
import com.kyluzoi.easeui.widget.EaseVoiceRecorderView.EaseVoiceRecorderCallback;
import com.kyluzoi.easeui.widget.chatrow.EaseCustomChatRowProvider;
import com.kyluzoi.easeui.zoihttp.MinganEntity;
...
public class EaseChatFragment extends EaseBaseFragment {
    ...
    protected void initView() {
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            // TODO: 2016/8/5 发送消息的回调 ，敏感词汇过滤在此判断
            @Override
            public void onSendMessage(final String content) {
                // 发送文本消息
                FormBody.Builder builder = new FormBody.Builder();
                builder.add("str", content)
                        .add("token", "5e299d88ddec71599c62c5f05abdc33d");
                ...
                okhttp.newCall(request).enqueue(new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        Toast.makeText(getActivity(), "网络差，请检查网络", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        Gson gson = new Gson();
                        MinganEntity o = gson.fromJson(response.body().charStream(), MinganEntity.class);
                        if (o.getCode() == 1) {
                            String message = o.getData().getNew_str();
...
//                sendTextMessage(content);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            ...
            titleBar.setRightImageGonggaoResource(R.drawable.gonggao);
        ...
        titleBar.setGonggaoClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
